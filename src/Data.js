...
export const aboutData = {
  ...
  subtitle:
    'kami adalah kompany yang mendedikasikan untuk mendistribusikan produk untuk di kirim menuju kerumah mu or dimana pun anda berada, with the best quality of delivery.',
};
